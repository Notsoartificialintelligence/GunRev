...
namespace GunRev
{
    public class TNTItem : PlayerItem
    {
        ...
        public IEnumerator Boom()
        {
            ...
            Exploder.Explode(tntObject.GetComponent<tk2dSprite>().WorldCenter, GameManager.Instance.Dungeon.sharedSettingsPrefab.DefaultExplosionData, tntObject.GetComponent<tk2dSprite>().WorldCenter);
