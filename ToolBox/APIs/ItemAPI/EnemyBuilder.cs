...
namespace ItemAPI
{
    public static class EnemyBuilder
    {
        ...
        public static void SetupEntry(this AIActor enemy, string shortDesc, string longDesc, string portrait, string AmmonomiconSprite, string EnemyName)
        {
            ...
            GunRev.Module.Strings.Enemies.Set("#" + EnemyName.ToUpper(), EnemyName);
            GunRev.Module.Strings.Enemies.Set("#" + shortDesc.ToUpper(), shortDesc);
            GunRev.Module.Strings.Enemies.Set("#" + longDesc.ToUpper(), longDesc);
    ...
    public class Tint : BraveBehaviour
    {
        private void Start()
        {
            ToolsOther.DisableSuperTinting(base.aiActor);
        }
    }
